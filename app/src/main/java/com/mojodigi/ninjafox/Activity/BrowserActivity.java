...
import com.mojodigi.ninjafox.org.askerov.dynamicgrid.DynamicGridView;
...
public class BrowserActivity extends Activity implements BrowserController {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // changed the default value  to 0 as per my need;
        if (anchor == 0) {
       ...
       // android.os.Debug.waitForDebugger();    //  forces app  to   enable dubuging;
    ...
    private void popUpMenu()
    {
        ...
        PopupMenu popup = new PopupMenu(mContext,omniboxOverflow);
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.menu_NewIncongnitoTab:
                        jmmToast.show(mContext, "new  incog tab");
                        break;
                    ...
                    case R.id.menu_DownLoads:
                        jmmToast.show(mContext, "download");
                        break;

                    case R.id.menu_History:
                        //display history url list;
                        addAlbum(BrowserUnit.FLAG_HISTORY);
                        increaseTabCount();
                        //jmmToast.show(mContext, "history");
                        break;

                    case R.id.menu_Settings:
                        jmmToast.show(mContext, "settings");
                        break;

                    case R.id.menu_FindinPage:
                        //  showSearchPanel();
                        //jmmToast.show(mContext, "find in page");
                        break;
                }
                return false;///////
            }
    ...
    private void increaseTabCount() {
        int tabCount=getTabCount();
        tabCount++;
        if(prefs!=null)
        {
            prefs.setIntValue(AppConstants.NUM_TABS, tabCount);
        }
        getTabCount();
    }
    private void decreaseTabCount()
    {
        int tabCount=getTabCount();
        if(tabCount>1)
            tabCount--;
    ...
    private void dispatchIntent(Intent intent) {
        ...
        if (intent != null && intent.hasExtra(IntentUnit.OPEN)) { // From HolderActivity's menu
            ...
            pinAlbums(null);
            /*this was  for home  introduction purpose not being used*/
       ...
       /*     SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(this);
            if (sp.getBoolean(getString(R.string.sp_first), true)) {
                ...
                //pinAlbums(BrowserUnit.BASE_URL + lang); it showa the  introduction  on installation
                pinAlbums(null);  // passing null  no introduction will  be shown on installation
    ...
    private void initSwitcherView() {
        ...
        switcherBookmarks.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //this can deleted as being displayed in menu
                addAlbum(BrowserUnit.FLAG_BOOKMARKS);
            }
        });
        ...
        switcherHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // this  can de delted as history is now being shown  from nav drawer;
                //addAlbum(BrowserUnit.FLAG_HISTORY);
            }
        });
    ...
    private void initOmnibox() {
        ...
        omniboxTabCount=(TextView) findViewById(R.id.omniTabCount);
      ...
      /*this is for swiping the  inputbox where it display  the title of the page on swipe*/
        ...
        omniboxTabCount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void initBHList(final jmmRelativeLayout layout, boolean update) {
        ...
        final RecordAdapter adapter = new RecordAdapter(mContext, R.layout.record_item, list);
    ...
    public synchronized void showAlbum(AlbumController controller, boolean anim, final boolean expand, final boolean capture) {
        ...
        if (currentAlbumController != null && anim) {
            ...
            contentFrame.addView((View) controller);    // added at first time

            //contentFrame.addView(contentContainerl);
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (s.equals(getString(R.string.main_menu_new_tab))) { // New tab
                    ...
                    BrowserUnit.copyURL(mContext, target);
                } else if (s.equals(getString(R.string.main_menu_save))) { // Save
                    BrowserUnit.download(mContext, target, target, BrowserUnit.MIME_TYPE_IMAGE);
                }
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (s.equals(array[0])) { // Go to top
                    ...
                    if (action.checkGridItem(customWebView.getUrl())) {
                        ...
                        if (BrowserUnit.bitmap2File(mContext, bitmap, filename) && action.addGridItem(item)) {
                    ...
                    if (token == null || token.trim().isEmpty()) {
                        ...
                        intent.putExtra(IntentUnit.URL, customWebView.getUrl());
                        startActivity(intent);
                    }
                    ...
                    if (!prepareRecord()) {
                        ...
                        jmmWebView customWebView = (jmmWebView) currentAlbumController;
                        IntentUnit.share(mContext, customWebView.getTitle(), customWebView.getUrl());
                    }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (s.equals(array[0])) { // New tab
                    ...
                    BrowserUnit.copyURL(mContext, record.getURL());
                } else if (s.equals(array[2])) { // Share
                    IntentUnit.share(mContext, record.getTitle(), record.getURL());
                } else if (s.equals(array[3])) { // Edit
