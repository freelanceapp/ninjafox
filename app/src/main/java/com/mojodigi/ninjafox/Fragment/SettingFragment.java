...
import com.mojodigi.ninjafox.Activity.ClearActivity;
import com.mojodigi.ninjafox.Activity.TokenActivity;
import com.mojodigi.ninjafox.Activity.WhitelistActivity;
import com.mojodigi.ninjafox.R;


import com.mojodigi.ninjafox.Task.ExportBookmarksTask;
...
public class SettingFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        switch (preference.getTitleRes()) {
            ...
            case R.string.setting_title_version:
                jmmToast.show(getActivity(), R.string.toast_emoji);
                break;
    ...
    public void onSharedPreferenceChanged(SharedPreferences sp, String key) {
        ...
        if (key.equals(getString(R.string.sp_search_engine))) {
            ...
            tabPosition.setSummary(summary);
            jmmToast.show(getActivity(), R.string.toast_need_restart);
